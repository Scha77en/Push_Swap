...
/*   Updated: 2023/04/13 07:15:01 by aouhbi           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if ((*sa)->content > (*sa)->next->content && (*sa)->content > (*sa)->next->next->content)
	{
		shift_up_stack_a(sa, 1);
		if ((*sa)->content > (*sa)->next->content)
			swap_a(sa, 1);
	}
	else if ((*sa)->content < (*sa)->next->content && (*sa)->content < (*sa)->next->next->content)
	{
